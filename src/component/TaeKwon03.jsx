...
async function predict() {
    ...
    for (let i = 0; i < maxPredictions; i++) {
        ...
        if(prediction[i].className ==="Stand" && prediction[i].probability > 0.9){
            if(stand === "OneHandGuard_L"){
                stand = "Stand";
                count++;
            } else if (stand === "OneHandGuard_R"){
                stand = "Stand";
                count++;
            }
        }
        if(prediction[i].className ==="OneHandGuard_L" && prediction[i].probability > 0.9){
            stand = "OneHandGuard_L";
        }
        if(prediction[i].className ==="OneHandGuard_R" && prediction[i].probability > 0.9){
