...
async function predict() {
    ...
    for (let i = 0; i < maxPredictions; i++) {
        ...
        if(prediction[i].className ==="Stand" && prediction[i].probability > 0.9){
            if(stand === "Straight_Left"){
                stand = "Stand";
                count++;
            } else if (stand === "Straight_Right"){
                stand = "Stand";
                count++;
            }
        }
        if(prediction[i].className ==="Straight_Left" && prediction[i].probability > 0.9){
            stand = "Straight_Left";
        }
        if(prediction[i].className ==="Straight_Right" && prediction[i].probability > 0.9){
